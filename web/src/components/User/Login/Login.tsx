...
<div id="footer">
  <Button shape="round" onClick={showAboutDrawer}>About</Button>
  <Drawer title="About" placement="bottom" onClose={onAboutClose} open={Aboutopen}>
  ...
  <Button shape="round" onClick={showCookieDrawer}>🍪</Button>



  <Drawer title="Cookie" placement="bottom" onClose={onCookieClose} open={Cookieopen}>
  <div>
  ...
  <Button shape="round" onClick={showTutorialDrawer}>？</Button>
  <Drawer title="Tutorial" placement="bottom" onClose={onTutorialClose} open={Tutorialopen}>
    <Tutorial></Tutorial>
  </Drawer>
</div>
    </div>
